...
<head>
  ...
  <title> Final_Laravel | @yield('title')</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('cms/plugins/fontawesome-free/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('https://site-assets.fontawesome.com/releases/v6.1.2/css/all.css') }}">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="fa-sharp fa-solid fa-person-military-to-person"></i>
                              <p>
                 الادوار
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="fa-sharp fa-solid fa-people-roof"></i>                <p>
                 الموظف
                <i class="fas fa-angle-left right"></i>
              </p>
            </a>
